...
\chapter{Topologické vlastnosti elektromagnetického pole}\label{teo:IchapII}
\minitoc
  ...
  \section{Topologie diskrétních útvarů}\label{teo:IchapIIsecI}
      ...
      \begin{figure}[ht!]
        ...
        \begin{tabular}{c}
          \subfloat[ ]{\label{es:fig_patocka_topol03a}
            \includegraphics[width=0.9\linewidth]{patocka_topol03a.png}}   \\
          \subfloat[ ]{\label{es:fig_patocka_topol03b}
            \includegraphics[width=0.9\linewidth]{patocka_topol03b.png}}
        \end{tabular}
    ...
    \subsection{Princip reciprocity v pasivních nelineárních 
    ...
    \subsection{Počet stupňů volnosti pasivního mnohopólu}\label{teo:IchapIIsecIsubIV}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cccc}
            \subfloat[ ]{\label{es:fig_patocka_topol05a}
              \includegraphics[width=0.11\linewidth]{patocka_topol05a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol05b}
              \includegraphics[width=0.18\linewidth]{patocka_topol05b.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol05c}
              \includegraphics[width=0.25\linewidth]{patocka_topol05c.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol05d}
              \includegraphics[width=0.25\linewidth]{patocka_topol05d.png}}
          \end{tabular}
    ...
    \subsection{Počet stupňů volnosti pasivního čtyřpólu}\label{teo:IchapIIsecIsubV}
    ...
    \subsection{Popis dvojbranu pomocí matic typu Z, Y, H}\label{teo:IchapIIsecIsubVII}
    ...
    \subsection{Přenosové parametry dvojbranu}\label{teo:IchapIIsecIsubVIII}
  ...
  \section{Topologie spojitých útvarů}\label{teo:IchapIIsecII}
    ...
    \begin{figure}[ht!]
      ...
      \begin{tabular}{cccc}
        \subfloat[ ]{\label{es:fig_patocka_topol09a}
          \includegraphics[width=0.15\linewidth]{patocka_topol09a.png}}   &
        \subfloat[ ]{\label{es:fig_patocka_topol09b}
          \includegraphics[width=0.22\linewidth]{patocka_topol09b.png}}   &
        \subfloat[ ]{\label{es:fig_patocka_topol09c}
          \includegraphics[width=0.22\linewidth]{patocka_topol09c.png}}   &
        \subfloat[ ]{\label{es:fig_patocka_topol09d}
          \includegraphics[width=0.23\linewidth]{patocka_topol09d.png}}
      \end{tabular}
    ...
    \begin{figure}[ht!]
      ...
      \begin{tabular}{cc}
        \subfloat[ ]{\label{es:fig_patocka_topol10a}
          \includegraphics[width=0.25\linewidth]{patocka_topol10a.png}}   &
        \subfloat[ ]{\label{es:fig_patocka_topol10b}
          \includegraphics[width=0.25\linewidth]{patocka_topol10b.png}}   
      \end{tabular}
    ...
    \begin{figure}[ht!]
      ...
      \begin{tabular}{ccc}
        \subfloat[ ]{\label{es:fig_patocka_topol11a}
          \includegraphics[width=0.27\linewidth]{patocka_topol11a.png}}   &
        \subfloat[ ]{\label{es:fig_patocka_topol11b}
          \includegraphics[width=0.27\linewidth]{patocka_topol11b.png}}   &
        \subfloat[ ]{\label{es:fig_patocka_topol11c}
          \includegraphics[width=0.27\linewidth]{patocka_topol11c.png}}
      \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol16a}
              \includegraphics[width=0.45\linewidth]{patocka_topol16a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol16b}
              \includegraphics[width=0.45\linewidth]{patocka_topol16b.png}}
          \end{tabular}
    ...
    \subsection{Vzduchová cívka z topologického hlediska}\label{teo:IchapIIsecIIsubV}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol17a}
              \includegraphics[width=0.4\linewidth]{patocka_topol17a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol17b}
              \includegraphics[width=0.4\linewidth]{patocka_topol17b.png}}
          \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol18a}
              \includegraphics[width=0.35\linewidth]{patocka_topol18a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol18b}
              \includegraphics[width=0.55\linewidth]{patocka_topol18b.png}}
          \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol19a}
              \includegraphics[width=0.37\linewidth]{patocka_topol19a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol19b}
              \includegraphics[width=0.37\linewidth]{patocka_topol19b.png}}
          \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol20a}
              \includegraphics[width=0.30\linewidth]{patocka_topol20a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol20b}
              \includegraphics[width=0.30\linewidth]{patocka_topol20b.png}}
          \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol21a}
              \includegraphics[width=0.4\linewidth]{patocka_topol21a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol21b}
              \includegraphics[width=0.4\linewidth]{patocka_topol21b.png}}
          \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol25a}
              \includegraphics[width=0.40\linewidth]{patocka_topol25a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol25b}
              \includegraphics[width=0.35\linewidth]{patocka_topol25b.png}}
          \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol26a}
              \includegraphics[width=0.25\linewidth]{patocka_topol26a.png}}   &
             \subfloat[ ]{\label{es:fig_patocka_topol26b}
               \includegraphics[width=0.25\linewidth]{patocka_topol26b.png}}
           \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol27a}
              \includegraphics[width=0.30\linewidth]{patocka_topol27a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol27b}
              \includegraphics[width=0.25\linewidth]{patocka_topol27b.png}}
          \end{tabular}
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{cc}
            \subfloat[ ]{\label{es:fig_patocka_topol28a}
              \includegraphics[width=0.30\linewidth]{patocka_topol28a.png}}   &
            \subfloat[ ]{\label{es:fig_patocka_topol28b}
              \includegraphics[width=0.25\linewidth]{patocka_topol28b.png}}
          \end{tabular}
      ...
      \subsubsection{Princip reciprocity ve spojitě rozprostřených obvodech}
        ...
        Postup důkazu:
        \begin{enumerate}
          \item Na desce zvolme v lib 	ovolných místech čtyři body \(A\), \(B\), \(C\), \(D\).    
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{c}
            \subfloat[ ]{\label{es:fig_patocka_topol31a}
              \includegraphics[width=0.80\linewidth]{patocka_topol31a.png}}   \\
            \subfloat[ ]{\label{es:fig_patocka_topol31b}
              \includegraphics[width=0.80\linewidth]{patocka_topol31b.png}}   \\
