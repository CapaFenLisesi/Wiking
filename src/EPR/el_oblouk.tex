...
\section{Teorie spínacího oblouku}
  \subsection{Plazma elektrického oblouku}
    ...
    plynem \ce{SF6} \cite[s.~3]{BartaVostracky}.
  \subsection{Charakteristika vypínacího pochodu}
    \subsubsection{Základní uspořádání zhášecích komor}
      ...
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{Barta_Vostracky_Komora_jednostrannym_proudenim.pdf}
      ...
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{Barta_Vostracky_Komora_dvoustrannym_proudenim.pdf}
      ...
      Na obrázcích je schématicky znázorněn oblouk, který je axiálně ofukován plynem z prostoru zhášecí 
      komory s tlakem $p_1$ přes zhášecí trysky dutinou kontaktů do výfuku, kde je nižší tlak $p_2$.
    ...
    \subsubsection{Tři základní intervaly vypínacího pochodu}
      ...
      \begin{figure*}
        \centering
        \rotatebox{90}{%
        \includegraphics[width=\textwidth]{Barta_Vostracky_Zakladni_intervaly_vypinaciho_pochodu.pdf}}
      ...
      Rozdělení vypínacího pochodu do těchto intervalů umožňuje snadněji specifikovat základní kritéria, 
    ...
    \begin{figure}
      ...
      \subfloat[Tepelné vodivosti dusíku (\ce{N2}) a fluoridu sírového (\ce{SF6})]
        {\label{epr:fig_oblouk_vodivost}
         \includegraphics[width=0.5\linewidth]{char_vodivost_teplota_SF6_N2.pdf}}
      \subfloat[Křivky rozdělení teplot oblouku v závislosti na poloměru oblouku v \ce{SF6}; 1 až 4
                různé proudy oblouku] 
        {\label{epr:fig_oblouk_trup}  
         \includegraphics[width=0.3\linewidth]{rozdeleni_teplot_oblouku.pdf}}
