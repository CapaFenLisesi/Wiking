...
\newpage
  ...
  \section{Bipolární digitální obvody}\label{CES:Bipolar_technology}
      ...
      \begin{figure}[hb!]
        ...
        \subfloat[Součtový člen]{\label{ces:fig_D_OR}
          \includegraphics[width=0.4\textwidth]{diodovy_log_OR.pdf}}
        \subfloat[Součinový člen]{\label{ces:fig_D_AND}
          \includegraphics[width=0.4\textwidth]{diodovy_log_AND.pdf}}
  ...
  \section{Přizpůsobení logických obvodů různých napěťových tříd} %Digital Interfacing
    ...
    \begin{figure}[ht!]
         \centering
         \includegraphics[width=0.7\textwidth]{digit_cir_output_common.pdf}
    ...
    \subsection{3.3V $\rightarrow$ 5V} %3.3V to 5V
      ...
      \subsubsection{MOSFET Translator}
        \begin{wrapfigure}{r}{6.1cm}
           \centering
           \includegraphics[scale=0.7]{level_shifting_MOSFET.pdf}
      ...
      \subsubsection{Diodový Offset}
        ...
        \begin{wrapfigure}{r}{6cm}
            \centering
            \includegraphics[scale=0.7]{level_shifting_diode_offset.pdf}
      ...
      \subsubsection{Komparátor}
        ...
        \begin{wrapfigure}{r}{6.5cm}
            ...
            \includegraphics[scale=0.6]{level_shifting_COMP.pdf}
    ...
    \subsection{5V $\rightarrow$ 3.3V} %5V to 3.3V
      \subsubsection{Přímé propojení}
        \begin{wrapfigure}{r}{6.5cm}
            \centering
            \includegraphics[scale=0.8]{direct_connect.pdf}
       ...
       \begin{figure}[ht!]
         ...
         \begin{tabular}{c}
           \subfloat[Vnitřními omezovací diody]{\label{CES:fig_int_clamp_D}
             \includegraphics[width=0.4\textwidth]{CES_clamp_diodes_input.png}}        \\
           \subfloat[Externí omezovací dioda]{\label{CES:fig_ext_clamp_D}     
             \includegraphics[width=0.4\textwidth]{CES_ext_clamp_diodes_input.png}}
         \end{tabular}  
      ...
      \subsubsection{Napěťový dělič} %Resistor divider
        ...
        \begin{figure}[ht!]
          \centering
          \includegraphics[scale=0.5]{CES_ext_res_divider.png}
        ...
        \begin{example} As an example, suppose the following conditions exist:
          ...
          \begin{equation*}
            R = - \frac{t}{C\cdot\ln\frac{V_F-V_A}{V_I-V_A}}
          \end{equation*}   
          Substitute values:
          \begin{equation*}
            R = - \frac{10\cdot10^{-7}}{35\cdot10^{-12}\cdot\ln\dfrac{3-0.66\cdot5}{0.3-0.66\cdot5}}
          \end{equation*}               
        ...
        \begin{figure}[ht!]
          ...
          \begin{tabular}{c}
            \subfloat[SPI sběrnice]{\label{CES:fig_level_translator1}
              \includegraphics[width=0.8\textwidth]{CES_ext_level_translator1.png}}           \\
            \subfloat[I2C sběrnice]{\label{CES:fig_level_translator2}
              \includegraphics[width=0.8\textwidth]{CES_ext_level_translator2.png}}
          \end{tabular}  
