...
\chapter{Elektromagnetizmus}\label{chap:fey_elmag}
\minitoc
\newpage
  %--------------- Elektrické síly ------------------------------------------------------------------
  \section{Elektrické síly}
    ...
    Řekli jsme, že elektrická síla podobně jako gravitační klesá nepřímo úměrně s druhou mocninou   
    ...
    \section{Elektrická a magnetická pole}
      ...
      \begin{figure}[ht!]
        \centering
          \subfloat[šipkami, jejichž velikosti a směry  udávají hodnoty vektorového pole v bodech, ze
                    kterých vycházejí.]{\label{fyz:fig_elmag01}
            \includegraphics[width=0.3\textwidth]{fey_elmag01.JPG}
          }\hspace{0.1\textwidth}                                                                       
          \subfloat[siločar, jejichž tečny mají v každém bodě směr vektoru pole a jejichž hustota je
                    úměrná velikostí vektoru pole.]{\label{fyz:fig_elmag02}
            \includegraphics[width=0.3\textwidth]{fey_elmag02.JPG}
          }  
  ...
  \section{Charakteristiky vektorových polí}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.9\linewidth]{fey_elmag03.JPG}
    ...
    \begin{figure}[h]
      ...
      \begin{tabular}{c}
        \subfloat[ ]{\label{fyz:fig_elmag04}
          \includegraphics[width=0.2\textwidth]{fey_elmag04.JPG}
        }                                                                          \\
        \subfloat[ ]{\label{fyz:fig_elmag05}
          \includegraphics[width=0.3\textwidth]{fey_elmag05.JPG}
        }                                                                          \\
        \subfloat[ ]{\label{fyz:fig_elmag06}
          \includegraphics[width=0.3\textwidth]{fey_elmag06.JPG}
        }                      
      \end{tabular}
    ...
    Veličinu nazvanou cirkulace definujeme jako výslednou rychlost kapaliny v trubic i násobenou délkou 
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.8\linewidth]{fey_elmag07.JPG}
      \captionof{figure}{Cirkulace vektorového pole je rovna součinu střední tangenciální složky 
  ...
  \section{Zákony elektromagnetizmu}
    ...
    Konstanta \(c^2\), která vystupuje v rovnici (\ref{FYZ:eq_fey_elmag09}), je druhou mocninou rychlosti 
    ...
    \begin{figure}[hb!]
      \includegraphics[width=\linewidth]{fey_elmag08.JPG}
    ...
    Jak působí na magnet vodič elektrického proudu? Proud ve vodiči vytváří vlastní magnetické pole, které 
    ...
    \begin{figure}   
      \includegraphics[width=\linewidth]{fey_elmag09.JPG}
      \captionof{figure}{Magnetické pole vodiče působí silou na magnet.}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.9\linewidth]{fey_elmag10.JPG}
    ...
    První člen na pravé straně rovnice (\ref{FYZ:eq_fey_elmag09}) objevil Maxwell čistě teoreticky a je 
    ...
    \begin{figure}
      \includegraphics[width=\linewidth]{fey_elmag11.JPG}
    ...
    \begin{figure}
      \includegraphics[width=0.8\linewidth]{fey_elmag12.JPG}
    ...
    \begin{figure}[hb!]
      ...
      \begin{tabular}{cc}
       \subfloat[3D úloha: jiskřiště hrot - deska ]{\label{temp:fig_3D_example}
         \includegraphics[width=0.2\textwidth]{3D_uloha.pdf}}                      &
       \subfloat[2D úloha: dvouvodičové vedení]{\label{temp:fig_2D_example}
         \includegraphics[width=0.2\textwidth]{2D_uloha.pdf}}                        \\
       \subfloat[1D úloha: koaxiální kabel]{\label{temp:fig_1Dr_example}
         \includegraphics[width=0.2\textwidth]{1D_r_uloha.pdf}}                    &
       \subfloat[1D úloha: deskový kondezátor]{\label{temp:fig_1Dx_example}
         \includegraphics[width=0.2\textwidth]{1D_x_uloha.pdf}}  
      \end{tabular}                          
  ...
  \section{Působení na dálku versus teorie pole}
    ...
    Co je „působení na dálku“? Je to pohled na svět, ve kterém interakce dvou hmotných objektů nevyžaduje 
    ...
    Tato myšlenka je podstatou teorie pole a je také základem všech moderních teorií popisujících svět 
