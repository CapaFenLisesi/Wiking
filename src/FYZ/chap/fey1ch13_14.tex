...
\minitoc
  \section{Energie padajícího tělesa}
    V kapitole \ref{chap:fey_z_e} jsme se zabývali zachováním energie. Přitom jsme nepoužili 
    ...
    \begin{wrapfigure}[14]{r}{5cm}  %\ref{fyz:fig023}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig023.pdf}
  ...
  \section{Práce vykonaná gravitací}
    ...
    \begin{wrapfigure}[8]{r}{5cm}  %\ref{fyz:fig024}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig024.pdf}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig026}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig026.pdf}
  ...
  \section{Gravitační pole velkých těles}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig027}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig027.pdf}
  ...
  \section{Konzervativní síly}
    ...
    \begin{wrapfigure}[11]{r}{5cm}  %\ref{fyz:fig020}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig020.pdf}
