...
\minitoc
  ...
  \section{Vektorové integrály, křivkový integrál \texorpdfstring{\(\nabla\Psi\)}{nabla psi}}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig033}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig033.pdf}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig157.pdf}
  ...
  \section{Tok vektorového pole}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig034}
      \centering
      \input{../src/FYZ/img/fyz_fig034.tex}
    ...
    \begin{figure}[ht!]
      \centering
      \input{../src/FYZ/img/fyz_fig214.tex}
  ...
  \section{Tok povrchem krychle. Gaussova věta}\hypertarget{fyz:sec_003}
    ...
    \begin{figure}
      \centering
      \input{../src/FYZ/img/fyz_fig215.tex}
    ...
    \subsection{Tepelná vodivost, rovnice difúze}
      ...
      \begin{figure}[ht!]  %\ref{fyz:fig035}
        \centering
        \includegraphics[width=0.7\linewidth]{fyz_fig035.pdf}
  ...
  \section{Cirkulace vektorového pole}
    ...
    \begin{figure}[ht!]
      \centering
      \subfloat[ ]{\label{fyz:fig201a}
        \includegraphics[width=0.45\linewidth]{fyz_fig201a.pdf}
      }   
      \subfloat[ ]{\label{fyz:fig201b} 
        \includegraphics[width=0.45\linewidth]{fyz_fig201b.pdf}
      }    
  ...
  \section{Cirkulace po obvodu čtverce. Stokesova věta}\hypertarget{fyz:sec_002}
