...
\minitoc
  ...
  \section{Coulombův zákon, superpozice}\hypertarget{fyz:IIchapIVsecII}{}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig202.pdf}
  ...
  \section{Elektrický potenciál}\label{fyz:IIchapIVsecIII}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig044}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig044.pdf}
    ...
    \begin{figure}[ht!]
      ...
      \begin{tabular}{cc}
        \subfloat[ ]{\label{fyz:fig203a}
          \includegraphics[width=0.45\linewidth]{fyz_fig203a.pdf}}              &
        \subfloat[ ]{\label{fyz:fig203b} 
          \includegraphics[width=0.45\linewidth]{fyz_fig203b.pdf}}  
      \end{tabular}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig045}
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig045.pdf}
  ...
  \section{Tok pole \texorpdfstring{\(\vec{E}\)}{E}}\label{fyz:IIchapIVsecV}
    ...
    \begin{figure}[ht!]  % \ref{fyz:fig204}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig204.pdf}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig205.pdf}
      \caption{Tok vektoru \(\vec{E}\) z plochy \(S\) je roven nule}
      \label{fyz:fig205} 
    \end{figure}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig206.pdf}
    ...
    \begin{figure}[ht!]
      \centering                  
      \includegraphics[width=0.6\linewidth]{fyz_fig207.pdf}
    ...
    \begin{figure}[ht!]
      ...
      \begin{tabular}{cc}
        \subfloat[ ]{\label{fyz:fig208a}
          \includegraphics[width=0.4\linewidth]{fyz_fig208a.jpg}}   &
        \subfloat[ ]{\label{fyz:fig208b}
          \includegraphics[width=0.4\linewidth]{fyz_fig208b.jpg}}
      \end{tabular}
  ...
  \section{Pole nabité koule}\label{fyz:IIchapIVsecVII}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig209.pdf}
  ...
  \section{Siločáry, ekvipotenciální plochy}\label{fyz:IIchapIVsecVIII}
    ...
    \begin{figure}[ht!]
      \centering
      \includegraphics[width=0.8\linewidth]{fyz_fig210.pdf}
    ...
    \begin{figure}[ht!]
     \centering
     \includegraphics[width=\linewidth]{fyz_fig211.pdf}
