...
{\tikzset{external/prefix={tikz/FYZII/}}
 \tikzset{external/figure name/.add={ch13__}{}}
%---------------------------------------------------------------------------------------------------
% file fey1ch01_02_03.tex
%---------------------------------------------------------------------------------------------------
%====================Kapitola:Magnetostatika========================================================
\chapter{Magnetostatika}\label{chap:fey_magnetostatics}
\minitoc
  ...
  \section{Magnetické pole}
    ...
    \subsection{Elektrický proud, zachování náboje}
      ...
      \end{equation}
      (Opět \hyperlink{fyz:sec_003}{Gaussova věta} z matematiky!)
    ...
    \subsection{Magnetické pole stacionárních proudů, Ampérův zákon}
      ...
      systému Maxwellových rovnic (\ref{fey:eq_div001}) vynechat členy s \(\pder{\vec{E}}{t}\) a 
