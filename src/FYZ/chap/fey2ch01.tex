    ...
    \begin{figure}[ht!]
      ...
      \begin{tabular}{cc}
       \subfloat[3D úloha: jiskřiště hrot - deska ]{\label{fyz:fig221a}
         \includegraphics[width=0.4\linewidth]{3D_uloha.pdf}}                      &
       \subfloat[2D úloha: dvouvodičové vedení]{\label{fyz:fig221b}
         \includegraphics[width=0.4\linewidth]{2D_uloha.pdf}}                        \\
       \subfloat[1D úloha: koaxiální kabel]{\label{fyz:fig221c}
         \includegraphics[width=0.4\linewidth]{1D_r_uloha.pdf}}                    &
       \subfloat[1D úloha: deskový kondezátor]{\label{fyz:fig221d}
         \includegraphics[width=0.4\linewidth]{1D_x_uloha.pdf}}  
      \end{tabular}                          
