...
\chapter{Zachování energie}\label{chap:fey_z_e}
\minitoc
    ...
    \begin{figure}[ht!]  % \ref{fyz:fig049}
      ...
      \begin{tabular}{cc}
        \subfloat[ ]{\label{fyz:fig049a}
          \includegraphics[width=0.35\linewidth]{fyz_fig049a.pdf}}
        \hspace{0.1\linewidth}                                                       &
        \subfloat[ ]{\label{fyz:fig049b}
          \includegraphics[width=0.35\linewidth]{fyz_fig049b.pdf}}                   \\
        \subfloat[ ]{\label{fyz:fig049c}
          \includegraphics[width=0.35\linewidth]{fyz_fig049c.pdf}}
        \hspace{0.1\linewidth}                                                       &
        \subfloat[ ]{\label{fyz:fig049d}
          \includegraphics[width=0.35\linewidth]{fyz_fig049d.pdf}}                   \\
        \subfloat[ ]{\label{fyz:fig049e}
          \includegraphics[width=0.35\linewidth]{fyz_fig049e.pdf}}
        \hspace{0.1\linewidth}                                                       &
        \subfloat[ ]{\label{fyz:fig049f}
          \includegraphics[width=0.35\linewidth]{fyz_fig049f.pdf}}
      \end{tabular}
