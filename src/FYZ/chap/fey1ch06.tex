...
\chapter{Pravděpodobnost}\label{chap:fey_ppst}
...
\minitoc
  \section{Možnost a pravděpodobnost}
    ...
    Mohli byste namítat, že žádná situace není přesně opakovatelná. To je pravda. Každé další 
    ...
    založená na skutečných pozorováních. \(N\) je náš nejlepší \emph{odhad} toho, co \emph{by mělo} 
    nastat při \(N\) \emph{myšlených} pozorováních. Pravděpodobnost proto závisí na našich 
    ...
    \begin{equation}\label{FYZ:eq070}
      N_Z = N_H = \frac{1}{2} \qquad \text{nebo}\qquad P(H) = P(Z) = \num{0.5}.
    \end{equation}
    ...
    V kapitole \ref{chap:fey_cas} jsme popisovali velikost jádra pomocí jeho zdánlivé plochy neboli 
  ...
  \section{Fluktuace}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig077}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig077.pdf}
    ...
    zmýlili v úvaze vedoucí k závěru, že nejpravděpodobnější počet hlav v takové hřeje \num{15}? 
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig079}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig079.png}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig078}
      \centering
      \includegraphics[width=0.95\linewidth]{fyz_fig078.pdf}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig081}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig081.pdf}
    ...
    \( \begin{pmatrix} n \\ k \end{pmatrix}\). Bude vhodné připomenout, že binomické koeficienty 
    ...
    \end{equation}
    kde \(n!\), nazývaný „n-faktoriál“, představuje součin \(n(n- l)(n-2)\cdots (3)(2)(1)\).
    
    \begin{figure}[ht!]  %\ref{fyz:fig080}
      \centering
      \includegraphics[width=0.6\linewidth]{fyz_fig080.pdf}
    ...
    hod připouští 2 výsledky) a počet způsobů získání \(k\) hlav je \( \begin{pmatrix} n \\ k 
    \end{pmatrix}\), přičemž všechny jsou stejně pravděpodobné. Proto máme
    ...
    \ref{fyz:fig081} prochází body vypočítanými ze vztahu \(100\cdot P(k, 30)\). Vidíme, že padnutí 
  ...
  \section{Náhodná procházka}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig083}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig083.pdf}
  ...
  \section{Rozložení pravděpodobnosti}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig084}
      \centering
      \includegraphics[width=0.9\linewidth]{fyz_fig084.pdf}
      \caption{Hustota pravděpodobnosti dosažení vzdálenosti \(D\) od počátku při náhodné procházce 
               sestávající z \(N\) kroků (\(D\) se měří v jednotkách střední kvadratické délky 
               kroku) (\cite[s.~87]{Feynman01})}
      \label{fyz:fig084}
    \end{figure}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig084}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig085.pdf}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig086}
      \centering
      \includegraphics[width=0.7\linewidth]{fyz_fig086.pdf}
  ...
  \section{Princip neurčitosti}
    ...
    \begin{figure}[ht!]  %\ref{fyz:fig087}
      \centering
      \begin{tabular}{cc}
        \subfloat[ ]{\label{fyz:fig087a}
          \includegraphics[width=0.4\linewidth]{fyz_fig087a.pdf}}
        \hspace{0.05\linewidth}                                                       &
        \subfloat[ ]{\label{fyz:fig087b}
          \includegraphics[width=0.4\linewidth]{fyz_fig087b.pdf}}
      \end{tabular}
