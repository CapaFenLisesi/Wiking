...
% Urcete maximalni dostrel pro zadanou ustovou rychlost,
% hranice oblasti, ve kterem lze zasahnout cil a stanovte
% velikost potrebneho nameru dela pro zasezeni libovolneho cile 
...
% 2. Vypocet nameru pro zasazeni zadaneho cile
    ...
    Diskriminant = sqrt(v0^4-(g0*(g0*cil(1)^2+2*v0^2*cil(2))));
    alfa1 = atan((v0^2-Diskriminant)/(g0*cil(1)));
    alfa2 = atan((v0^2+Diskriminant)/(g0*cil(1)));
