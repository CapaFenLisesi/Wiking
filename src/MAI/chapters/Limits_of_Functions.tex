...
\minitoc
  ...
  \section{Reálná funkce}
    ...
    \subsection{Funkce a její graf}\label{MAI:section_002}
      ...
      \begin{figure}[ht!] %\ref{mai_fig001}
        \centering
          ...
          \begin{figure}[ht!]
            ...
            \begin{tabular}{cc}
              \subfloat[ ]{\label{MAI:fig_011}
                \input{../src/MAI/img/mai_fig002.tex}}              &
              \subfloat[ ]{\label{MAI:fig_010}
                \input{../src/MAI/img/mai_fig003.tex}}              \\
            \end{tabular}
...
%      x\) (ačkoliv by bylo důslednější mluvit o funkci \(\sin\)) apod. \cite[s.~82]{Brabec1989} 
    ...
    \subsection{Graf funkce}\label{MAI:section_001}\hypertarget{MAI:section_001}
      ...
      funkci, snadno zjistíme, že její graf nemůžeme sestrojit (obr. \ref{mai_fig005} tedy 
      není grafem funkce, ale pouze pokusem o názorné přiblížení Dirichletovi funkce)
      
      \begin{figure}[ht!] %\ref{mai_fig005}
        \centering
    ...
    \subsection{Skládání a inverze funkcí}
      ...
      \begin{figure}[ht!] %\ref{mai_fig012}
        \centering
      ...
      \begin{figure}[ht!] %\ref{mai_fig014}
        \centering
       ...
       \begin{figure}[ht!]
         ...
         \begin{tabular}{cc}
           \subfloat[ ]{\label{mai_fig016a}
             \input{../src/MAI/img/mai_fig016a.tex}}              &
           \subfloat[ ]{\label{mai_fig016b}
             \input{../src/MAI/img/mai_fig016b.tex}}              \\
         \end{tabular}
